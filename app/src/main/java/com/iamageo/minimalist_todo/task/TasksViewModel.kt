...
import com.iamageo.minimalist_todo.data.Result.Success
import com.iamageo.minimalist_todo.data.Task
import com.iamageo.minimalist_todo.data.source.DefaultTasksRepository
import com.iamageo.minimalist_todo.util.ADD_EDIT_RESULT_OK
import com.iamageo.minimalist_todo.util.DELETE_RESULT_OK
import com.iamageo.minimalist_todo.util.EDIT_RESULT_OK
import com.iamageo.minimalist_todo.util.Event
        ...
        when (requestType) {
            TasksFilterType.ALL_TASKS -> {
                setFilter(
                    ...
                    R.drawable.ic_empty, true
                )
            }
            TasksFilterType.ACTIVE_TASKS -> {
                setFilter(
                    R.string.label_active, R.string.no_tasks_active,
                    R.drawable.ic_active, false
                )
            }
            TasksFilterType.COMPLETED_TASKS -> {
                setFilter(
                    R.string.label_completed, R.string.no_tasks_completed,
                    R.drawable.ic_completed, false
                )
            }
        }
        loadTasks(false)
